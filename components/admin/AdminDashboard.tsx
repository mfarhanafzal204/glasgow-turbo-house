            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`relative flex flex-col sm:flex-row items-center justify-center sm:justify-start space-y-1 sm:space-y-0 sm:space-x-2 py-2 px-2 sm:px-3 lg:px-4 border-b-2 font-medium text-xs sm:text-sm whitespace-nowrap min-w-0 ${
                    activeTab === tab.id
